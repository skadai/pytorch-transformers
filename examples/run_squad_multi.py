...
from pytorch_transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForQuestionAnswering, BertEcomCommentMulti, BertTokenizer,
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertEcomCommentMulti, BertTokenizer),
    ...
    for dirname in dirlist:
        ...
        if evaluate:
            ...
            dataset = TensorDataset(all_input_ids, all_input_mask, all_segment_ids,
                                    ...
                                    all_question_ids, all_cls_index, all_p_mask)
